...
@onready var falling_key = preload("res://cenas/fases/fase_boto/objects/falling_key.tscn")
@onready var score_text = preload("res://cenas/fases/fase_boto/objects/score_press_text.tscn")
